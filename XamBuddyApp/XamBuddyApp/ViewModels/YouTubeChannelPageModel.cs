...
namespace XamBuddyApp.ViewModels
{
    ...
    public class YouTubeChannelPageModel : FreshBasePageModel
    {
        ...
        const string ApiKey = "AIzaSyCdWxPC6l0PdqhooSiIXLVayo89leedIRk";//"AIzaSyB2Hu4D97zOB8f410cwT2rCc6JnmwoLCAo";
        const string ChannelId = "UCmcWO6GbETogq_ULHf1PX2A";// "UCoal_hpPIPAnWlG-kWHLheA";



        /*YouTube User ID: mcWO6GbETogq_ULHf1PX2A
        YouTube Channel ID: UCmcWO6GbETogq_ULHf1PX2A
        YouTube ApiKey: "AIzaSyCdWxPC6l0PdqhooSiIXLVayo89leedIRk";*/
